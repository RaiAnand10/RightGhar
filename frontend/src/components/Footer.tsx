        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-stone-400 leading-relaxed">
              India's only aggregator for newly launched properties. Compare projects, verify RERA details, and make informed decisions—all in one place.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-xs text-stone-500">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>116+ New Launch Projects</span>
            </div>
          </div>
        </div>
      </div>
