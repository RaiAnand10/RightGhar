...
import AIGharView from './AIGharView'
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-1 p-1 bg-stone-50 rounded-lg border border-stone-200 self-start sm:self-auto">
                ...
                >
                  ...
                  <span className="hidden sm:inline">AIGHAR</span>
                </button>
              </div>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="w-12 h-12 border-4 border-stone-200 border-t-teal-500 rounded-full animate-spin mb-4"></div>
            <p className="text-stone-500">Loading properties...</p>
          </div>
        )}
        ...
        {error && !loading && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h3 className="font-display text-xl text-stone-900 mb-2">Failed to load properties</h3>
        ...
        {/* Filters & Content - only show when data is loaded */}
        {!loading && !error && (
        <>
        {/* Filters — hidden in AI view */}
        {viewMode !== 'ai' && (
        <FilterSort
        ...
        {/* Results */}
        {viewMode === 'ai' ? (
          <AIGharView onPropertyClick={handlePropertyClick} />
        ) : viewMode === 'map' ? (
          <MapView
